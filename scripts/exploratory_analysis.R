...
stargazer(lm1, lm2, lm3, lm4, lm5, lm6, 
          se = list(lm1se, lm2se, lm3se, lm4se, lm5se, lm6se), 
          p.auto = FALSE, 
...
stargazer(lm1.d, lm2.d, lm3.d, lm4.d, lm5.d, lm6, se = list(lm1.dse, lm2.dse, lm3.dse, lm4.dse, lm5.dse, lm6.dse), 
          p.auto = FALSE, 
          omit = c("Constant", "as\\.factor\\(COWcode\\)", "as\\.factor\\(year\\)"), 
          omit.stat = c("adj.rsq", "ser", "f", "rsq"), 
          covariate.labels = c("Institutionalization", "Strength", "Fuel Income", "Population", "Capital Stock", "Income Inequality"), 
...
stargazer(lm1.a, lm2.a, lm3.a, lm4.a, lm5.a, lm6.a, se=list(lm1.ase, lm2.ase, lm3.ase, lm4.ase, lm5.ase, lm6.ase), p.auto = F, 
          omit = c("Constant", "as\\.factor\\(COWcode\\)", "as\\.factor\\(year\\)"), 
          omit.stat = c("adj.rsq", "ser", "f", "rsq"), 
          covariate.labels = c("Institutionalization", "Strength", "Fuel Income", "Population", "Capital Stock", "Income Inequality"), 
          digits = 2)
