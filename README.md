...
To use our original dataset from our "Party Institutionalization and Party Strength: A New Global Dataset" paper, click [here](pips/pips_beta3.csv). Our codebook for the dataset is [here](pips/PIPS%20Codebook.pdf). 
...
[data_set_creation](scripts/data_set_creation_beta3.R): where we create our dataset with our reordered v2panom and other variables. 
